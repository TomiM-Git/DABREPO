...
#   ******************************************************************************
    ...
    print("Desfase proporcional entre puentes:   D = ",round(D,2))
...
#**** Primeros cálculos auxiliares de variaciones de corriente. ****
    ...
    print("Variación en intervalo       [0:phi]: dI1 = ",round(dI1,2)," [A]")
    print("Variación en intervalo      [phi:PI]: dI2 = ",round(dI2,2)," [A]")
    print("Variación en intervalo   [PI:PI+phi]: dI3 = ",round(dI3,2)," [A]")
    print("Variación en intervalo [PI+phi:2*PI]: dI4 = ",round(dI4,2)," [A]")
#****       ****
